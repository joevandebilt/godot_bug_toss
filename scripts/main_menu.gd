...
func _ready() -> void:
	new_game_button = get_node("MarginContainer/ColumnsContainer/ButtonsContainer/New Game Button")
	new_game_button.pressed.connect(_new_game)		
	
	hi_score_button = get_node("MarginContainer/ColumnsContainer/ButtonsContainer/Hi Scores Button")
	hi_score_button.pressed.connect(_hi_scores)
	
	quit_button = get_node("MarginContainer/ColumnsContainer/ButtonsContainer/Quit Button")
